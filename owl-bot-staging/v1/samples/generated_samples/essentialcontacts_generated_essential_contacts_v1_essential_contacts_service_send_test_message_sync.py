...
# [START essentialcontacts_generated_essential_contacts_v1_EssentialContactsService_SendTestMessage_sync]
...
def sample_send_test_message():
    ...
    # Make the request
    response = client.send_test_message(request=request)


# [END essentialcontacts_generated_essential_contacts_v1_EssentialContactsService_SendTestMessage_sync]
