...
# [START essentialcontacts_generated_essential_contacts_v1_EssentialContactsService_DeleteContact_sync]
...
def sample_delete_contact():
    ...
    # Make the request
    response = client.delete_contact(request=request)


# [END essentialcontacts_generated_essential_contacts_v1_EssentialContactsService_DeleteContact_sync]
